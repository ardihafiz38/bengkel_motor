            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Bengkel Motor</h1>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_aksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Jadwal</label>
                                        <div class="col-sm-8">
                                            <input name="Jadwal" class="form-control" type="text" id="Jadwal" type="text" value="<?php echo $data['Jadwal']; ?>" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="no_handphone" class="form-control" id="no_handphone" type="text" value="<?php echo $data['no_handphone']; ?>" required />
                                        </div>
                                    </div>
                                     <div class="form-group">
